...
internal sealed class TestableAssemblyEnumerator : AssemblyEnumerator
{
    ...
    internal override TypeEnumerator GetTypeEnumerator(IReadOnlyCollection<Attribute> assemblyAttributes, string assemblyFileName, Type type, IReadOnlyCollection<Attribute> typeAttributes, bool discoverInternals, TestIdGenerationStrategy testIdGenerationStrategy)
